...
import 'package:google_places_api/models/place_prediction.dart';
...
void main() {
  ...
  () {
    ...
    () {
      ...
      var tResponseFromJson = PlaceAutocompleteResponse.fromJson(json.decode(jsonMap));
      ///act
      var tResponseFromObject = PlaceAutocompleteResponse(
  ...
  () {
    ...
    () async {
      ...
      .thenAnswer((_) async => Response(fixture('place_autocomplete_test_data.json'), 200, headers: utf8Header));
      ///act
